...
export default function Login() {
  return (
    <div className="">
      ...
      <main className="flex flex-row w-screen my-8 text-center">
        <div className="flex flex-col w-5/12 p-3 mx-12 border border-black">
          <p className="my-10">
        ...
        <div className="flex flex-col w-5/12 mx-12 border border-black">
          <form className="flex flex-col w-full m-auto my-10">

            <input placeholder="Input Email" className="w-2/3 p-4 m-auto my-3 text-center border border-4 border-black"type="text" ></input>          
            <input placeholder="Password" className="w-2/3 p-4 m-auto my-3 text-center border border-4 border-black"type="text" ></input>
            <button className="w-6/12 p-4 m-auto my-8 border border-4 border-black">Login</button>
            <button className="w-5/12 m-auto border border-4 border-black p-7">Create Account</button>
          </form>
        </div>
